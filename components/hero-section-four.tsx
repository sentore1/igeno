                        ...
                        <div className="relative z-10 mx-auto max-w-5xl px-6">
                            <div className="relative text-center">
                                ...
                                <div className="flex flex-col items-center justify-center gap-3 *:w-full sm:flex-row sm:*:w-auto">
                                    <Button size="lg" render={<Link href="#link" />} nativeButton={false}><span className="text-nowrap">Get Started</span></Button>
                                    <Button key={2} size="lg" variant="outline" render={<Link href="#link" />} nativeButton={false}><span className="text-nowrap">View Demo</span></Button>
                                </div>
                            </div>
