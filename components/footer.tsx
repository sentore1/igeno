...
const links = [
    { title: 'Care Services', href: '/care' },
    { title: 'Academy', href: '/academy' },
    { title: 'Dashboard', href: '/dashboard' },
    { title: 'Book a Service', href: '/care/booking' },
    { title: 'Courses', href: '/academy/courses' },
    { title: 'About', href: '#' },
]
        ...
        <footer className="bg-muted py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm">
                    © {new Date().getFullYear()} Igeno Gate, All rights reserved
                </span>
            </div>
        </footer>
    )
